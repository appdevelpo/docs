...
3. **Language guide**: go to the page for your language —
   ...
   - **Go Extensions**: [Get Started](/docs/en/developer/go/1-get-started/) → [Detail Usage](/docs/en/developer/go/2-detail-usage/) → [Running with Native Go](/docs/en/developer/go/3-running-native/) / [Running with Scriggo](/docs/en/developer/go/4-running-scriggo/) → [Data Formats](/docs/en/developer/5-data/).
