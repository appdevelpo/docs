...
3. **Language guide**: go to the page for your language —
   - **JavaScript Extensions**: [Get Started (V2)](/en/developer/js/1-get-started/) (recommended) / [Legacy V1](/en/developer/js/2-legacy-v1/) (compatibility) / [Data Formats (V2 / V1 legacy)](/en/developer/5-data/).
   - **Go Extensions**: [Get Started](/en/developer/go/1-get-started/) → [Detail Usage](/en/developer/go/2-detail-usage/) → [Running with Native Go](/en/developer/go/3-running-native/) / [Running with Scriggo](/en/developer/go/4-running-scriggo/) → [Data Formats](/en/developer/5-data/).
...
4. **Data Formats** ([Data Formats (V2 / V1 legacy)](/en/developer/5-data/)): a reference for the input parameters and return structures of every entry point; V2 is current, V1 legacy is kept only for compatibility, and their per-type playback shapes are identical.
