...
本页定义每个扩展入口的**输入参数和返回结构**，与 [JavaScript 扩展 (V2)](/developer/js/1-get-started/) / [Go 扩展](/developer/go/1-get-started/) 中的入口函数一一对应。
...
:::caution
V1 已不再推荐用于新扩展；新扩展请统一使用 V2（见 [JavaScript 扩展](/developer/js/1-get-started/) 与 [Go 扩展](/developer/go/1-get-started/)）。
:::
