...
本页深入讲解 Go 扩展的 `sdk` 用法、返回类型、完整示例、Scriggo 限制与可导入的包。入口函数的声明见 [快速开始](/developer/go/1-get-started/)；两种运行方式见 [原生 Go 运行](/developer/go/3-running-native/) 与 [Scriggo 运行](/developer/go/4-running-scriggo/)。
