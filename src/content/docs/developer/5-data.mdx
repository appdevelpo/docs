...
本頁定義每個擴展入口的**輸入參數和返回結構**，與 [JavaScript 擴展 (V2)](/docs/developer/js/1-get-started/) / [Go 擴展](/docs/developer/go/1-get-started/) 中的入口函數一一對應。
...
:::caution
V1 已不再推薦用於新插件；新插件請統一使用 V2（見 [JavaScript 插件](/docs/developer/js/1-get-started/) 與 [Go 插件](/docs/developer/go/1-get-started/)）。
:::
